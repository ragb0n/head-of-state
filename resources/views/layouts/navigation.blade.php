<nav x-data="{ open: false }" class="bg-red-500 fixed top-0 w-full shadow-xl">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="flex-shrink-1 flex items-center relative top-5">
                    <a href="{{ route('dashboard') }}">
                        <div id="logo" class="shadow-md" style="margin: 0 auto; max-width: 150px;">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1 mt-10">
